...
const PhoneView=({currentSong})=>
 {
    ...
    return(
        ...
        <div class="player">
        <div class="overlay" style={{  background: `url(${currentSong.imageSrc ? currentSong.imageSrc : 'https://img.freepik.com/free-vector/elegant-musical-notes-music-chord-background_1017-20759.jpg?w=360'})`,
